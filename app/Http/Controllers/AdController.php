...
{
    public function admin(){                 //return bug forum
        return view('admin_login');
    }
    
    public function adminlogin(Request $request){                 //return bug forum
...
if( $data){
    ...
    public function edituser($id){                 //return bug forum
     
       $users = Signup::find($id);
        return view('UpdateUser',['users'=>$users]);
    }
    
    public function Uuser(Request $request,$id){                 //return bug forum
     ...
     public function deleteuser($id){     
        DB::table('signups')->where('id', $id)->delete();            //return bug forum
        return redirect()->action('AdController@dashboard');
     }
     
     public function showgpu(){                 //return bug forum
        $users = DB::select('select * from gpus');
   
        return view('dashboardgpushow',['users'=>$users]);
    }
    
    public function showcpu(){                 //return bug forum
    ...
    public function gpu_update(Request $request,$id){                 //return bug forum
